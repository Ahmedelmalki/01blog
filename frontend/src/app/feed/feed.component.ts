...
import { PostCardComponent } from '../shared/post-cards/post-card.component'; // ../shared/post-cards/post-card.component
...
@Component({
  selector: 'app-feed',
  standalone: true,
  imports: [CommonModule, RouterLink, PostCardComponent], // Import PostCardComponent
